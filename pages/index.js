  ...
  const renderSaleForm = function () {
    ...
    return (
      <div className='home__sellPicaroContainer'>
        <input className='home__input' type="number" placeholder="Precio del picaro" onChange={onPriceChanged} />
        {/* <p><a onClick={createSale} href="">Vender picaro por {price || '??'} tokens.</a></p> */}
        <p><button className='home__buttonRoseGradient' onClick={createSale}>Vender picaro</button></p>
      </div>
    )
  };
      ...
      <Layout>
        <main className='home__principalContainer'>
          <hgroup className='home__connectSection'>
            ...
            <img className='home__picaroImage' src='/assets/hockeyPicaro.png'/>
